                ...
                <div className="w-full max-w-[440px] space-y-8">
                    <div className="text-center lg:text-left">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 text-sm mt-2">
                            {isResetting ? 'We\'ll send you a link to your email.' : 'Welcome back! Please enter your details.'}
                        </p>
                    </div>

                    <form onSubmit={isResetting ? handleResetPassword : handleEmailLogin} className="space-y-5">
                        <div className="space-y-4">
                            {/* Email Input */}
                        ...
                        {successMessage && (
                            <div className="p-3 rounded-lg bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 text-xs font-medium border border-emerald-100 dark:border-emerald-900/30 flex items-center gap-2">
                                <CheckCircle size={14} />
                                {successMessage}
                            </div>
                        )}
                        ...
                        >
                            {loading ? 'Processing...' : (isResetting ? 'Send Reset Link' : 'Log In')}
                        </button>
