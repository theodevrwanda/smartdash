                        ...
                        <tbody className="divide-y divide-slate-100 dark:divide-slate-900">
                            {processedEmployees.map((employee, index) => (
                                <tr key={employee.id} className="group hover:bg-blue-50/50 dark:hover:bg-blue-900/20 transition-all duration-300 even:bg-slate-50/50 dark:even:bg-slate-900/10 whitespace-nowrap">
                                    ...
                                    <td className="px-4 py-3 border border-slate-200 dark:border-slate-800 shadow-inner">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-[9px] font-bold text-slate-400 dark:text-white font-mono">UID: {employee.id.substring(0, 12).toUpperCase()}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-4 py-3 border border-slate-200 dark:border-slate-800">
                                        <span className="text-[11px] font-bold text-slate-500 dark:text-white italic underline decoration-slate-200 underline-offset-4">{employee.email || 'NO_EMAIL_VECTOR'}</span>
                                    </td>
                                    <td className="px-4 py-3 border border-slate-200 dark:border-slate-800 uppercase text-[10px] font-black text-slate-600 dark:text-white tracking-widest bg-slate-50/50 dark:bg-slate-900/20">
                                        {employee.phone || '---'}
                                    </td>
                                    <td className="px-4 py-3 border border-slate-200 dark:border-slate-800">
                                    ...
                                    <td className="px-4 py-3 border border-slate-200 dark:border-slate-800">
                                        <span className="text-sm font-black text-slate-700 dark:text-white uppercase tracking-tighter leading-tight italic decoration-slate-200 underline decoration-2 underline-offset-4">{employee.businessName || 'INDEPENDENT'}</span>
                                    </td>
                                    <td className="px-4 py-3 border border-slate-200 dark:border-slate-800">
                                    ...
                                    <td className="px-4 py-3 border border-slate-200 dark:border-slate-800">
                                        <span className="text-[10px] font-black text-slate-500 dark:text-white uppercase tracking-widest">{employee.district || '---'}</span>
                                    </td>
                                    <td className="px-4 py-3 border border-slate-200 dark:border-slate-800">
                                        <span className="text-[10px] font-black text-slate-500 dark:text-white uppercase tracking-widest">{employee.sector || '---'}</span>
                                    </td>
                                    <td className="px-4 py-3 border border-slate-200 dark:border-slate-800">
                                    ...
                                    <td className="px-4 py-3 border border-slate-200 dark:border-slate-800">
                                        <div className="flex flex-col gap-0.5">
                                            <div className="flex items-center gap-1.5 text-[10px] font-black text-slate-700 dark:text-white uppercase tracking-tighter">
                                                <Calendar size={10} className="text-slate-400 dark:text-white" /> {employee.createdAt ? new Date(employee.createdAt).toLocaleDateString() : 'UNKNOWN'}
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td colSpan="30" className="px-6 py-40 text-center">
                                        <div className="flex flex-col items-center gap-6 opacity-40">
                                            ...
                                            <div className="space-y-1">
                                                <p className="text-slate-500 dark:text-white font-extrabold uppercase tracking-[0.2em] text-sm">Personnel Vector Not Found</p>
                                                <p className="text-[11px] font-bold text-slate-400 dark:text-white uppercase tracking-tight">Adjust your search parameters or filter matrix to locate the agent.</p>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
