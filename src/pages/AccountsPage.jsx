    ...
    return (
        <div className="flex flex-col h-full -mt-2">
            <div className="flex items-center justify-between mb-4">
                <h2 className="font-bold text-xl text-slate-800">All Businesses</h2>
                <button onClick={loadBusinesses} className="px-4 py-2 bg-white border border-slate-200 text-slate-600 rounded-lg text-sm font-medium hover:bg-slate-50 transition-colors shadow-sm">Refresh</button>
            </div>
                ...
                <table className="w-full min-w-[1200px] text-left border-separate border-spacing-0 text-sm">
                    <thead className="sticky top-0 z-20">
                        <tr className="bg-slate-50 font-semibold text-slate-600">
                            ...
                            <th className="px-4 py-3 bg-slate-100/80 border-b border-r border-slate-200">Owner</th>
                            <th className="px-4 py-3 bg-slate-100/80 border-b border-r border-slate-200">Plan</th>
                            <th className="px-4 py-3 bg-slate-100/80 border-b border-r border-slate-200">Sub. Status</th>
                            <th className="px-4 py-3 bg-slate-100/80 border-b border-r border-slate-200">Active</th>
                            <th className="px-4 py-3 bg-slate-100/80 border-b border-r border-slate-200">Start Date</th>
                            <th className="px-4 py-3 bg-slate-100/80 border-b border-r border-slate-200">End Date</th>
                    ...
                    <tbody className="divide-y divide-slate-100">
                        {businesses.map((business) => (
                            <tr key={business.id} className="hover:bg-blue-50/30 transition-colors group">
                                <td className="px-4 py-2 border-b border-r border-slate-100 font-medium text-slate-800">
                                ...
                                <td className="px-4 py-2 border-b border-r border-slate-100 text-slate-600">
                                    <div className="flex flex-col">
                                ...
                                <td className="px-4 py-2 border-b border-r border-slate-100 text-sm text-slate-600">
                                ...
                                <td className="px-4 py-2 border-b border-r border-slate-100 text-slate-500 text-xs text-center">
                                ...
                                <td className="px-4 py-2 border-b border-r border-slate-100 text-slate-600 text-xs">
                                ...
                                <td className="px-4 py-2 border-b border-slate-100 text-right">
                                    <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button
                                            ...
                                            className="p-1.5 text-slate-400 hover:text-blue-600 hover:bg-blue-50 rounded border border-slate-200"
                                        >
                                            <Eye size={14} />
                                        </button>

                                        {editingId !== business.id && (
                                            <button title="Change Plan" onClick={() => handleEditPlan(business)} className="p-1.5 text-slate-400 hover:text-purple-600 hover:bg-purple-50 rounded border border-slate-200">
                                                <CreditCard size={14} />
                                            </button>
                                        )}
                                        ...
                                        <button
                                            ...
                                            className={`p-1.5 rounded border border-slate-200 ${business.isActive ? 'text-slate-400 hover:text-red-600 hover:bg-red-50' : 'text-slate-400 hover:text-green-600 hover:bg-green-50'}`}
                                        >
